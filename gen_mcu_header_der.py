...
def gen_mcu_header_der(config):
    ...
    for client in clients:
        ...
        try:
            ...
            with open(store_folder+alias+'.ca', 'rb') as f:
                ca_data = f.read()
    ...
    try:
        ...
        with open(store_folder+'certificates_der.h', 'w', encoding='utf-8') as f:
